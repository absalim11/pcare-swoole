<?php
/**
 * Simple Benchmark Script for Non-Swoole
...
echo "=== SIMPLE BENCHMARK TEST (NON-SWOOLE) ===\n";
...
// Run Apache Bench
$command = sprintf(
    'ab -n %d -c %d -g non_swoole_benchmark_gnuplot.tsv http://%s:%d/ 2>&1',
    $totalRequests,
    $concurrentRequests,
    $host,
    $port
...
echo "\n=== BENCHMARK COMPLETE ===\n";
echo "Gnuplot data saved to: non_swoole_benchmark_gnuplot.tsv\n";
